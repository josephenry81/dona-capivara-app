...
export default function ClientHome({ initialData }: { initialData: any }) {
    ...
    useEffect(() => {
        ...
        // ⚡ NO MORE CLIENT-SIDE FETCH - Data already loaded from server!
        console.log('✅ [CLIENT] Using server-side data - instant load!', {
