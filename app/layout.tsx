...
export const metadata: Metadata = {
    ...
    description: "Os melhores geladinhos gourmet de Curitiba. Sabores artesanais, frescos e deliciosos. Peça pelo WhatsApp!",
    manifest: "/manifest.json",

    // SEO Keywords
    keywords: ['geladinho gourmet', 'picolé artesanal', 'geladinho curitiba', 'dona capivara', 'sobremesa gelada', 'delivery geladinho'],
