...
export default function Banner({
    ...
    return (
        <div className="w-full relative overflow-hidden rounded-2xl shadow-lg my-6">
            {/* Responsive Aspect Ratio Container: 4:5 on Mobile, 16:9 on Desktop */}
            <div className="relative w-full aspect-video md:aspect-[3/1] bg-gradient-to-r from-[#FF4B82] to-[#FF9E3D]">
