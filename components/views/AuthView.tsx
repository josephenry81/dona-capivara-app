            ...
            <div className="w-full max-w-sm bg-white rounded-[2rem] shadow-2xl p-8 z-10 mb-4">
                <div className="flex mb-6 bg-gray-100 p-1 rounded-xl">
                    <button
                        ...
                        className={`flex-1 py-2.5 text-sm font-bold rounded-lg transition-all ${!isSignup ? 'bg-white text-[#FF4B82] shadow-sm' : 'text-gray-400'}`}
                    >
                        Entrar
                    </button>
                    <button
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                    {isSignup && (
                        <div className="space-y-1">
                            ...
                            <input
                                ...
                                required={isSignup}
                                className="w-full p-3.5 bg-gray-50 border border-gray-200 rounded-xl text-sm outline-none focus:border-[#FF4B82]"
                                value={formData.name}
                    ...
                    <button
                        type="submit"
                        disabled={isLoading}
                        className="w-full bg-gradient-to-r from-[#FF4B82] to-[#FF9E3D] text-white font-bold py-4 rounded-xl shadow-lg shadow-orange-200 mt-4 disabled:opacity-70"
                    >
                ...
                <div className="mt-6 text-center">
                    <button onClick={onGuest} className="text-gray-400 text-xs font-bold hover:text-[#FF4B82]">
