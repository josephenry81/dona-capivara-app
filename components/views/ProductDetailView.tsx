...
export default function ProductDetailView({
    ...
    const handleSubmitReview = async (rating: number, comment: string) => {
        ...
        const result = await ReviewService.submitReview(product.id, product.nome, rating, comment, user);
                    ...
                    <div className="fixed bottom-0 left-0 w-full bg-white/80 backdrop-blur-2xl border-t border-white/50 p-6 pb-10 flex items-center justify-center gap-5 z-40 shadow-[0_-15px_40px_rgba(0,0,0,0.08)]">
                        <div className="max-w-3xl w-full flex items-center gap-4">
                            ...
                            <button
                                ...
                                className={`flex-1 h-16 group relative overflow-hidden font-black text-lg rounded-[24px] shadow-2xl transition-all duration-300 active:scale-95 flex items-center justify-center ${
                                    product.estoque > 0
            ...
            <div className="fixed bottom-0 left-0 w-full bg-white/95 backdrop-blur-3xl border-t border-gray-100 p-6 pb-12 z-40 shadow-[0_-25px_60px_rgba(0,0,0,0.15)] flex justify-center">
                <div className="max-w-4xl w-full flex items-center gap-6">
                    ...
                    <button
                        ...
                        disabled={product.estoque < 1}
                        className={`flex-1 h-16 group relative overflow-hidden font-semibold text-lg rounded-[28px] shadow-2xl transition-all duration-300 active:scale-[0.97] flex items-center justify-between px-8 ${
                            product.estoque > 0
