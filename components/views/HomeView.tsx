        ...
        <div className="min-h-screen bg-[#F5F6FA] pb-24">
            ...
            <div className="-mt-8 mx-6 relative z-20">
                <div className="flex items-center gap-3">
                    {/* Search Input */}
                    <div className="flex-1 bg-white rounded-full shadow-lg flex items-center px-5 py-4 border border-gray-100">
                        <svg
                    ...
                    <button
                        ...
                        className={`w-14 h-14 rounded-2xl shadow-lg flex items-center justify-center transition-all active:scale-95 ${
                            activeFilters.length > 0 ? 'bg-[#FF4B82] text-white' : 'bg-[#FF4B82] text-white'
                        }`}
                        title="Filtrar"
                    >
                        <svg
                        ...
                        {activeFilters.length > 0 && (
                            <span className="absolute -top-1 -right-1 bg-white text-[#FF4B82] text-[10px] font-black w-5 h-5 rounded-full flex items-center justify-center shadow-md">
