    ...
    return (
        ...
        >
            ...
            <div className="flex-1 min-w-0">
                <p className={`font-black text-sm tracking-tight truncate ${isOutOfStock ? 'line-through text-gray-400' : 'text-gray-900'}`}>
                    {option.name}
                </p>
                {option.sku && (
                    <p className="text-[10px] text-gray-400 font-bold uppercase tracking-wider truncate">Ref: {option.sku}</p>
                )}
            </div>
