    ...
    if (variant === 'icon') {
        return (
            <button
                onClick={handleShare}
                disabled={isSharing}
                className={`bg-blue-500 text-white p-3 rounded-full hover:bg-blue-600 transition active:scale-95 disabled:opacity-50 disabled:cursor-not-allowed shadow-md ${className}`}
